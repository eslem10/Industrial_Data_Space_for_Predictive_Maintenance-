...
ports `29191` (default API), `29193` (management API) and `29194` (DSP API), and the provider will listen on the
ports `19191` (default API), `19193` (management API) and `19194` (DSP API).

You can verify that the connectors are running with:

```powershell
Test-NetConnection localhost -Port 19194
Test-NetConnection localhost -Port 29194
```

Both commands should report `TcpTestSucceeded : True`.
